...
//посмотреть еще проверки на добавление элемента в конструктор, проверить src картинки ингредиента, проверить наличие оверлея после закрытия кликом по оверлею
